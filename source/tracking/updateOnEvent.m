function [particles, state_prior] = updateOnEventAverage(particles_prior, event, intensities, state_prior, params)
% input:
...
INTENSITY_THRESHOLD = params.pixelIntensityThreshold; %0.22;
u = event(1); v = event(2);
